...
int			rtc_scn_init(t_scn **scn_ptr, t_idm *idm)
{
	...
	scene->objects[1].local_x = (t_vec3){1.0, 0.0, 0.0};
	scene->objects[1].local_y = (t_vec3){0.0, 1.0, 0.0};
	scene->objects[1].local_z = (t_vec3){0.0, 0.0, 1.0};
	...
	scene->objects[2].local_x = (t_vec3){1.0, 0.0, 0.0};
	scene->objects[2].local_y = (t_vec3){0.0, 1.0, 0.0};
	scene->objects[2].local_z = (t_vec3){0.0, 0.0, 1.0};
	...
	scene->objects[3].local_x = (t_vec3){1.0, 0.0, 0.0};
	scene->objects[3].local_y = (t_vec3){0.0, 1.0, 0.0};
	scene->objects[3].local_z = (t_vec3){0.0, 0.0, 1.0};
	...
	scene->objects[4].local_x = (t_vec3){1.0, 0.0, 0.0};
	scene->objects[4].local_y = (t_vec3){0.0, 1.0, 0.0};
	scene->objects[4].local_z = (t_vec3){0.0, 0.0, 1.0};
	...
	scene->objects[5].local_x = (t_vec3){1.0, 0.0, 0.0};
	scene->objects[5].local_y = (t_vec3){0.0, 1.0, 0.0};
	scene->objects[5].local_z = (t_vec3){0.0, 0.0, 1.0};
	scene->objects[5].obj.torus.center = (t_vec3){0, 0, 30};
